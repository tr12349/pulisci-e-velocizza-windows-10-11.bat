...
:: IMPOSTAZIONE AZZURRO BRILLANTE
color 0B
set "ora_inizio=%TIME:~0,8%"

for /F "tokens=1,2 delims=#" %%a in ('"prompt #$H# & echo on & for %%b in (1) do rem"') do set "ESC=%%a"

set "total_steps=725"
set "current_step=0"
title âš¡ SYSTEM OPTIMIZER - [725 OPERAZIONI]

:: SCHERMATA DI PARTENZA CON BARRA VUOTA (PASSAGGIO 0)
cls
echo =======================================================
echo    ðŸš€ AVVIO PULIZIA E OTTIMIZZAZIONE DEL SISTEMA
echo =======================================================
echo %ESC%[91mðŸ›‘ ATTENZIONE: Non spegnere il computer fino alla fine!%ESC%[92m
echo =======================================================
echo.
echo âš™ï¸ Avanzamento: [â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘] 0%%  [0/725]
echo.
timeout /t 2 >nul
set /a current_step+=1
cls
echo =======================================================
echo    AVVIO PULIZIA E OTTIMIZZAZIONE DEL SISTEMA (725 OP)
echo =======================================================
echo.
echo Avanzamento: [%current_step%/%total_steps%]
...
echo =======================================================
echo.
echo 🕒 Ora inizio: %ora_inizio%
echo 🕒 Ora fine  : %TIME:~0,8%
echo.
echo =======================================================
pause
exit
...
cls
echo =======================================================
echo    âœ… OTTIMIZZAZIONE COMPLETATA CON SUCCESSO!
echo =======================================================
echo.
echo ðŸ•’ Ora inizio: %ora_inizio%
echo ðŸ•’ Ora fine  : %TIME:~0,8%
echo.
echo =======================================================
pause
exitecho 
